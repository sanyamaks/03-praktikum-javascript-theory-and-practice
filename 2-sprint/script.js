...
Критические замечания предыдущего ревью исправлены, кроме до конца правильной валидации формы карточки.


Что нужно исправить до конца.

1. Ещё раз повторяю:
в слушателе открытия формы профиля нужно производить удаление сообщений об ошибках.
...
Теперь валидация формы профиля работает правильно во всех случаях.
